...
@Component({
  selector: 'multi-product-editor',
  templateUrl: './multi-product-editor.component.html',
  styleUrls: ['./multi-product-editor.component.scss']
})
export class MultiProductEditorComponent implements OnInit {
	...
	ngOnInit() {
		...
		this.subscriptionPicture = this.rx.select<IPicture[]>('changed_pictures').subscribe(
			changedPictures=>{
				//self.user = account;
